...
/** Allows you to append a numeric value to an NSMutableData object and pad it to any length.
 ...
 @param length The number of bytes thvalueuld be used to store the vallength value will be padded
 to length bytes regardless of the number of bytes required to store it.
 */
- (void)appendValue:(long)value length:(int)length;
...
- (NSString *)psd_packedBitsDescription;
...
/** A special version of packedBits which will take the data and pack every nth
 ...
 @param range The range within the data object that should be encoded. range
 ...
 */
- (NSData *)psd_packedBitsForRange:(NSRange)range skip:(int)skip;
- (NSData *)psd_packedBitsWithSkip:(int)skip;
